...
const SPEAKER_IMAGE = '/majidsir.png' // Placeholder path
...
/**
 * SpeakerSection: Dedicated section for the main speaker
 */
const SpeakerSection = ({ language }: { language: 'en' | 'ar' }) => {
...
export default function About({ language = 'en' }: AboutProps) {
  ...
  return (
    <>
      ...
      {/* Speaker Section - Added Here */}
      <SpeakerSection language={language} />
